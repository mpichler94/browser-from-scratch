...
private class SocketHandler {
    ...
    private fun createSocket(request: Request): Socket =
...
internal data class Cookie(
    ...
    val expires: Instant = Instant.MAX,
) {
    companion object {
    ...
    override fun toString(): String = "$value;${parameters.entries.joinToString(";") { "${it.key}=${it.value}" }}"
}
