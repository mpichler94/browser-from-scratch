...
internal class TagSelector(
    private val tag: String,
) : Selector {
    override val priority = 1

    override fun matches(node: Token): Boolean = node is Element && tag == node.tag
...
internal class DescendantSelector(
    private val ancestor: Selector,
    private val descendant: Selector,
) : Selector {
...
internal class ListSelector(
    ...
    override fun matches(node: Token): Boolean = selectors.any { it.matches(node) }
...
fun Selector.cascadePriority(): Int = priority
